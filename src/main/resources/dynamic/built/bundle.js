...
var App = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement(React.Fragment, null, "Time server recieved request: ", /*#__PURE__*/React.createElement(TestComponent, {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            redirect = _args.length > 1 && _args[1] !== undefined ? _args[1] : 'follow';
            _context.next = 4;
            return fetch(url, {
              method: 'GET',
              mode: 'cors',
